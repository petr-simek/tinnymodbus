...
DEVS_ENABLE="-DBH1750 -DSHT31 -DSCD41 -DDS18B20"
...
avr-gcc -c $CFLAGS -flto -MF build/scd41.o.d    -Wa,-adhlns=build/scd41.lst      devs/scd41.c    -o build/scd41.o
