...
avrdude -V -pattiny85 -carduino -P/dev/tty.usbmodem14301 -b19200 $FUSE_FLAGS -U flash:w:boot.hex -e -v -U eeprom:w:boot.eep
avrdude -V -pattiny85 -carduino -P/dev/tty.usbmodem14301 -b19200 -D -U flash:w:main.hex -v
